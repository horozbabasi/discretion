...
**SEVEN ITEMS ARE OPEN. None may be reported as done.** Closed since M12: the `isComposing` send route (D63), and the store promotional assets and review-panel screenshot (D60/D62). NOT closed, despite being briefly recorded as done: the privacy-policy URL, which is item 5 - the repository is private and the URL 404s.
