...
[@privacyshield/core](../../README.md) / [index](../README.md) / decide

# Function: decide()

> **decide**(`entity`, `profileIn`, `lists?`): [`ProfileDecision`](../interfaces/ProfileDecision.md)

Defined in: [packages/core/src/fuse/profiles.ts:155](https://github.com/horozbabasi/privacyshield/blob/b5e097aedd021fca70f7b2cc252a9eff1043721e/packages/core/src/fuse/profiles.ts#L155)
