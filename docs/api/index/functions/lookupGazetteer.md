...
[@privacyshield/core](../../README.md) / [index](../README.md) / lookupGazetteer

# Function: lookupGazetteer()

> **lookupGazetteer**(`value`, `type`): [`GazetteerHit`](../interfaces/GazetteerHit.md) \| `undefined`

Defined in: [packages/core/src/gazetteer/index.ts:115](https://github.com/horozbabasi/privacyshield/blob/b5e097aedd021fca70f7b2cc252a9eff1043721e/packages/core/src/gazetteer/index.ts#L115)
