...
[@privacyshield/core](../../README.md) / [index](../README.md) / maskOriginal

# Function: maskOriginal()

> **maskOriginal**(`original`, `candidates`, `vault`, `options?`): [`MaskResult`](../interfaces/MaskResult.md)

Defined in: [packages/core/src/mask/masker.ts:104](https://github.com/horozbabasi/privacyshield/blob/b5e097aedd021fca70f7b2cc252a9eff1043721e/packages/core/src/mask/masker.ts#L104)
