...
[@privacyshield/core](../../README.md) / [index](../README.md) / protect

# Function: protect()

> **protect**(`text`, `options?`): `Promise`\<[`ProtectResult`](../interfaces/ProtectResult.md)\>

Defined in: [packages/core/src/protect.ts:179](https://github.com/horozbabasi/privacyshield/blob/b5e097aedd021fca70f7b2cc252a9eff1043721e/packages/core/src/protect.ts#L179)
