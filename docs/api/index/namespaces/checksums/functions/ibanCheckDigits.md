...
[@discretion/core](../../../../README.md) / [index](../../../README.md) / [checksums](../README.md) / ibanCheckDigits

# Function: ibanCheckDigits()

> **ibanCheckDigits**(`countryCode`, `bban`): `string` \| `null`

Defined in: [packages/core/src/checksums/mod97.ts:71](https://github.com/horozbabasi/privacyshield/blob/1ed43083dc5f2fa94a4eff8cba71ae6aeb5df89d/packages/core/src/checksums/mod97.ts#L71)
