...
[@discretion/core](../../README.md) / [index](../README.md) / CONFIDENCE

# Variable: CONFIDENCE

> `const` **CONFIDENCE**: `object`

Defined in: [packages/core/src/detect/types.ts:39](https://github.com/horozbabasi/privacyshield/blob/1ed43083dc5f2fa94a4eff8cba71ae6aeb5df89d/packages/core/src/detect/types.ts#L39)
