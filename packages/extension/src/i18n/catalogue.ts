...
export const EN = {
  ...
  'options.intro': 'Everything here is stored on this device only.',
  'options.section.types': 'Types to detect',
  'options.types.hint': 'Everything is detected unless you switch it off here.',
  'options.section.rules': 'Your own patterns',
  'options.section.region': 'Phone numbers',
  'options.section.data': 'Your settings file',
  'options.section.about': 'What this protects, and what it does not',
  'options.lists.hint': 'One entry per line. These are saved on this device, as you type them.',
  'options.rules.name': 'Name',
  'options.rules.pattern': 'Pattern',
  'options.rules.add': 'Add pattern',
  'options.rules.matches': { one: '$1 match', other: '$1 matches' },
  'options.rules.remove': 'Remove',
  'options.rules.empty': 'No patterns of your own yet.',
  'options.rules.invalid': 'Not a valid pattern.',
  'options.rules.tryIt': 'Try it on some text',
  'options.rules.notStored': 'This test box is not saved anywhere.',
  'options.region.hint': 'Used for numbers written without a country code.',
  'options.export': 'Save to a file',
  'options.import': 'Load from a file',
  'options.imported': 'Settings loaded.',
  'options.importFailed': 'That file could not be read as settings.',
  'options.exportWarn': 'The file includes your two lists, in plain text.',
  'options.about.does': 'It checks what you type or paste into ChatGPT, Claude and Gemini, and replaces sensitive values before the message is sent. If it cannot check, it stops the message rather than letting it through.',
  'options.about.notFiles': 'It does not protect files, images or screenshots you attach.',
  'options.about.notElsewhere': 'It does not protect anything you send from another app, unless you mask it with Quick Redact first.',
  'options.about.notPerfect': 'It will miss some things and flag some harmless ones. Read the review panel before you send.',
  'options.about.notTyping': 'The site can see what is in the box while you type. Only what you SEND is masked.',
  'options.saved': 'Saved',
} as const;
