...
export const DE: Catalogue = {
  ...
  'panel.review.aria': 'Discretion: Prüfen Sie vor dem Senden, was maskiert wird',
  ...
  'panel.unwitnessed.body':
    'Dieser Text stand bereits im Feld – Discretion hat nicht gesehen, wie Sie ihn eingegeben haben. Das ist normal bei einem gespeicherten Entwurf, einem Link, der das Feld für Sie ausfüllt, oder einem Vorschlag.',

  'panel.findings.aria': {
    one: 'Discretion: $1 sensibles Element in dieser Nachricht erkannt',
    other: 'Discretion: $1 sensible Elemente in dieser Nachricht erkannt',
  },
  ...
  'panel.degraded.pageTitle': 'Discretion schützt diese Seite nicht',
  'panel.degraded.sendTitle': 'Discretion hat diese Nachricht nicht gesendet',
  ...
  'popup.status.unsupported': 'Discretion läuft auf dieser Website nicht',
  ...
  'options.title': 'Discretion-Einstellungen',
